    ...
    <v-container fluid class="pa-6">
          ...
          <div class="d-flex align-center justify-space-between mb-6">
            <div>
              ...
              <p class="text-subtitle-1 text-grey-darken-2">
                Manage and track damaged goods
              </p>
            </div>
      ...
      <v-row class="mb-6">
        <v-col cols="12" sm="4">
          <v-card color="orange-lighten-3" variant="elevated">
            <v-card-text class="text-center pa-4">
              <v-icon size="32" color="orange-darken-2" icon="mdi-package-variant-minus" class="mb-2"></v-icon>
              <h3 class="text-h5 font-weight-bold text-orange-darken-4">0</h3>
              <p class="mb-0">Total Damaged Items</p>
            </v-card-text>
          </v-card>
        </v-col>
        <v-col cols="12" sm="4">
          <v-card color="blue-lighten-4" variant="elevated">
            <v-card-text class="text-center pa-4">
              <v-icon size="32" color="blue-darken-2" icon="mdi-progress-alert" class="mb-2"></v-icon>
        ...
        <v-col cols="12" sm="4">
          <v-card color="green-lighten-4" variant="elevated">
            <v-card-text class="text-center pa-4">
              <v-icon size="32" color="green-darken-2" icon="mdi-package-variant-closed-remove" class="mb-2"></v-icon>
        ...
        <v-card-text class="pa-6">
          <v-row>
            ...
            <v-col cols="12" md="3">
              <v-select
                label="Status"
                :items="['All', 'Pending Inspection', 'Disposed']"
                variant="outlined"
                density="compact"
                hide-details
              ></v-select>
      ...
      <v-card class="elevation-4">
        <v-card-title class="text-h6 font-weight-bold text-orange-darken-4 pa-6">
          <v-icon icon="mdi-package-variant-minus" class="me-2"></v-icon>
          Damaged Goods
        </v-card-title>
        <v-data-table
          :headers="headers"
...
function getStatusColor(status: string) {
  if (status === 'Disposed') return 'green';
  return 'blue';
}
</script>